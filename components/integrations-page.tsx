  ...
  return (
    <div className="w-full min-h-screen p-6 lg:p-12 overflow-x-hidden bg-background">
      ...
      <div className="mb-12">
        ...
        <p className="text-base text-muted-foreground">Connect tools to HeartMetrics for better data insights</p>
      </div>
              ...
              <div className="flex items-start justify-between mb-4">
                ...
                <button
                  ...
                  className={`ml-4 flex-shrink-0 relative inline-flex h-8 w-14 rounded-full transition-colors ${
                    integ.connected ? 'bg-green-600' : 'bg-border'
                  }`}
                >
                  <span
        ...
        <div>
          <div className="mb-8 p-6 rounded-lg border border-blue-500/30 bg-blue-500/10">
            <div className="flex items-start gap-3 mb-4">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground mb-2">Data Privacy & Controls</h3>
                <p className="text-sm text-muted-foreground">Manage what data HeartMetrics can access and how it's used</p>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-lg border border-border p-6 bg-card">
              ...
              <div className="space-y-3">
                <label className="flex items-center p-3 rounded-lg border border-border cursor-pointer hover:bg-muted/50 transition-colors">
                  ...
                  <span className="ml-3 text-sm text-card-foreground">Allow email analysis for recognition patterns</span>
                </label>
                <label className="flex items-center p-3 rounded-lg border border-border cursor-pointer hover:bg-muted/50 transition-colors">
                  <input type="checkbox" defaultChecked className="w-4 h-4 rounded" />
                  <span className="ml-3 text-sm text-card-foreground">Allow meeting analysis for workload metrics</span>
                </label>
                <label className="flex items-center p-3 rounded-lg border border-border cursor-pointer hover:bg-muted/50 transition-colors">
                  <input type="checkbox" className="w-4 h-4 rounded" />
                  <span className="ml-3 text-sm text-card-foreground">Allow Slack channel monitoring</span>
                </label>
              </div>
            </div>
            ...
            <div className="rounded-lg border border-border p-6 bg-card">
              ...
              <div className="space-y-3">
                <label className="flex items-center p-3 rounded-lg border border-border cursor-pointer hover:bg-muted/50 transition-colors">
                  <input type="checkbox" defaultChecked className="w-4 h-4 rounded" />
                  <span className="ml-3 text-sm text-card-foreground">Anonymize personal data in reports</span>
                </label>
                <label className="flex items-center p-3 rounded-lg border border-border cursor-pointer hover:bg-muted/50 transition-colors">
                  <input type="checkbox" defaultChecked className="w-4 h-4 rounded" />
                  <span className="ml-3 text-sm text-card-foreground">Exclude contractors from analysis</span>
                </label>
                <label className="flex items-center p-3 rounded-lg border border-border cursor-pointer hover:bg-muted/50 transition-colors">
                  <input type="checkbox" className="w-4 h-4 rounded" />
                  <span className="ml-3 text-sm text-card-foreground">Retain data for compliance audit trail</span>
                </label>
              </div>
            </div>
          </div>
