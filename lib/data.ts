...
export const employees: Employee[] = [
  {
    id: "1", name: "Riya S.", role: "Analyst", wwi: 41, wwiTrend: "down", confidence: "High",
  ...
  {
    id: "3", name: "Emma K.", role: "Senior Analyst", wwi: 78, wwiTrend: "up", confidence: "High",
  ...
  {
    id: "4", name: "Noah T.", role: "Analyst", wwi: 60, wwiTrend: "down", confidence: "Medium",
  ...
  {
    id: "6", name: "Chen L.", role: "Team Lead", wwi: 84, wwiTrend: "up", confidence: "High",
  ...
  {
    id: "8", name: "Fatima A.", role: "Analyst", wwi: 66, wwiTrend: "up", confidence: "High",
  ...
  {
    id: "9", name: "Mason G.", role: "Analyst", wwi: 58, wwiTrend: "neutral", confidence: "Medium",
  ...
  {
    id: "10", name: "Olivia B.", role: "Junior", wwi: 63, wwiTrend: "up", confidence: "High",
...
export const orgAverages = {
  wwiAverage: 62, highRiskCount: 3, blockedWorkItems: 8, managerFairnessScore: 69,
...
export const insights: Insight[] = [
  { id: "1", priority: "High", category: "Retention Risk", title: "Riya S. burnout risk escalating", description: "Riya's WWI dropped to 41 with 3 blocked items and 12.5h meetings weekly. Her workload has been elevated for 3 consecutive weeks.", whyItMatters: "Employees with WWI below 45 for more than 2 weeks are 3x more likely to disengage or leave within 90 days. Riya is a tenured analyst with deep domain knowledge.", suggestedAction: "Reassign 2 tasks and schedule a supportive 1:1 this week", suggestedActionLabel: "Take Action", status: "active", date: "2026-02-10" },
  ...
  { id: "4", priority: "Medium", category: "Engagement", title: "Noah T. sentiment trending down", description: "Noah's WWI dropped from 68 to 60 over 3 weeks. He has 2 blocked items and his trend is consistently downward.", whyItMatters: "Declining trends that persist for 3+ weeks often indicate deeper issues like unclear goals, lack of support, or interpersonal friction.", suggestedAction: "Schedule a check-in 1:1 focused on support needs", suggestedActionLabel: "Schedule 1:1", status: "active", date: "2026-02-08" },
  { id: "5", priority: "Low", category: "Growth", title: "Olivia B. ready for stretch assignment", description: "Olivia's WWI is stable at 63 with light workload (WIP: 4). She has capacity and her growth signals indicate readiness.", whyItMatters: "Junior team members who receive stretch assignments within their first 6 months show 40% faster skill development.", suggestedAction: "Assign the next cross-functional project to Olivia", suggestedActionLabel: "Assign Project", status: "active", date: "2026-02-07" },
...
export const notifications: Notification[] = [
  { id: "1", type: "alert", title: "Riya's burnout risk moved to High", description: "WWI dropped to 41 with 3 blocked items", time: "2h ago", group: "today", read: false, target: "team-health" },
  ...
  { id: "3", type: "positive", title: "Team sentiment is up 12% this week", description: "5 of 10 members show improved WWI scores", time: "6h ago", group: "today", read: false, target: "overview" },
...
export const oneOnOnes: OneOnOne[] = [
  ...
  { id: "2", employeeId: "2", employeeName: "Diego P.", employeeRole: "Specialist", nextDate: "2026-02-13", nextTime: "2:00 PM", lastDate: "2026-02-01", status: "needs-prep",
    talkingPoints: ["Medium risk flag -- WWI at 52", "Workload is high with 8 WIP items", "No public recognition in 30 days"],
  ...
  { id: "3", employeeId: "3", employeeName: "Emma K.", employeeRole: "Senior Analyst", nextDate: "2026-02-14", nextTime: "11:00 AM", lastDate: "2026-02-05", status: "prepped",
    talkingPoints: ["Strong performance -- WWI at 78 and trending up", "Discuss growth goals and potential tech lead path", "Review mentoring of Olivia"],
  ...
  { id: "4", employeeId: "4", employeeName: "Noah T.", employeeRole: "Analyst", nextDate: "2026-02-11", nextTime: "3:00 PM", lastDate: "2026-01-28", status: "overdue",
    talkingPoints: ["WWI declining from 68 to 60 over 3 weeks", "2 blocked items need resolution", "Sentiment trending down -- check in on support needs"],
  ...
  { id: "5", employeeId: "5", employeeName: "Priya R.", employeeRole: "Analyst", nextDate: "2026-02-15", nextTime: "10:30 AM", lastDate: "2026-02-03", status: "prepped",
    talkingPoints: ["Shipped auth module ahead of schedule -- recognize!", "WWI at 55, stable but no recognition received", "Discuss growth opportunities"],
  ...
  { id: "6", employeeId: "7", employeeName: "Sam J.", employeeRole: "Ops", nextDate: "2026-02-11", nextTime: "4:00 PM", lastDate: "2026-01-25", status: "overdue",
    talkingPoints: ["WWI at 49 -- high risk", "45% firefighting ratio is unsustainable", "WIP at 10 is highest on team", "Need to redistribute urgent tasks"],
  ...
  { id: "7", employeeId: "6", employeeName: "Chen L.", employeeRole: "Team Lead", nextDate: "2026-02-16", nextTime: "9:00 AM", lastDate: "2026-02-07", status: "prepped",
    talkingPoints: ["Strong WWI at 84 -- top performer", "Discuss team-wide stretch work distribution", "Review fairness score trends"],
  ...
  { id: "8", employeeId: "8", employeeName: "Fatima A.", employeeRole: "Analyst", nextDate: "2026-02-17", nextTime: "1:00 PM", lastDate: "2026-02-04", status: "prepped",
    talkingPoints: ["WWI improving at 66", "Workload balanced", "Explore interest in cross-team projects"],
  ...
  { id: "9", employeeId: "9", employeeName: "Mason G.", employeeRole: "Analyst", nextDate: "2026-02-12", nextTime: "2:30 PM", lastDate: "2026-01-23", status: "overdue",
    talkingPoints: ["No recognition in 30 days", "2 blocked items with avg 5 days blocked", "WWI flat at 58 -- needs attention"],
  ...
  { id: "10", employeeId: "10", employeeName: "Olivia B.", employeeRole: "Junior", nextDate: "2026-02-18", nextTime: "11:30 AM", lastDate: "2026-02-06", status: "prepped",
    talkingPoints: ["WWI at 63 and improving", "Light workload -- capacity for more", "Mentorship with Emma going well"],
...
export const objectives: Objective[] = [
  ...
  {
    id: "o2", title: "Raise team WWI to 72+", owner: "Alex M.", level: "team", dueDate: "2026-03-31",
    keyResults: [
      { id: "kr4", title: "Zero employees below WWI 50", progress: 60, target: "0 employees", status: "At Risk" },
...
export const timelineEvents: TimelineEvent[] = [
  ...
  { id: "t9", type: "alert", description: "Riya S.'s WWI dropped below 45 -- burnout risk flagged", timestamp: "2026-01-28T09:00:00", details: "WWI at 41, down from 52 two weeks ago" },
...
export const reportTemplates: ReportTemplate[] = [
  ...
  { id: "r2", title: "Monthly Manager Review", description: "Full overview with charts, 1:1 cadence, survey results, and goal progress", lastGenerated: "2026-01-31", sections: ["Team Overview", "WWI Trends", "1:1 Cadence", "Survey Results", "Goal Progress", "Recognition Stats"] },
...
// ===== MULTI-TEAM DATA =====
export const teams = [
  { id: "t1", name: "AR Ops Team", size: 10, wwi: 67, engagement: 72, workloadBalance: 65, recognitionFreq: 60, cadence: 78, goalCompletion: 67 },
  { id: "t2", name: "Frontend Squad", size: 8, wwi: 72, engagement: 75, workloadBalance: 70, recognitionFreq: 68, cadence: 82, goalCompletion: 74 },
  { id: "t3", name: "Platform Team", size: 12, wwi: 59, engagement: 61, workloadBalance: 52, recognitionFreq: 45, cadence: 65, goalCompletion: 58 },
  { id: "t4", name: "Design Pod", size: 5, wwi: 76, engagement: 80, workloadBalance: 78, recognitionFreq: 72, cadence: 90, goalCompletion: 80 },
]
